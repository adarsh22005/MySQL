...
values
(109,'Rishab','sharma','adarshsharma22220@gmail.com', '2025-09-08','2005-05-22');
...
select sum(Balance) as total_balance
from accounts
where accounttype="salary";

select avg(Balance) as Total_Average
from accounts
where accounttype="SALARY";

select max(Balance) as hightest_balance
from accounts;
